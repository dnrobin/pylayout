...
class Transform:
    ...
    def apply(self, xy):
        """ apply transformation to xy point (or list of points) """
    ...
    @property
    def ax(self):
        return Vector(self.__scale.x*cos(self.__rotation), 
                self.__scale.y*sin(self.__rotation))

    @property
    def ay(self):
        return Vector(self.__scale.x*sin(self.__rotation), 
                -self.__scale.y*cos(self.__rotation))
